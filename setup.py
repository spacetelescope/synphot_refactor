...
from astropy_helpers.setup_helpers import (
    register_commands, get_debug_option, get_package_info)  # noqa
...
setup(name=PACKAGENAME,
      ...
      scripts=scripts,
      python_requires='>=3.5',
      install_requires=['numpy>=1.13', 'astropy>=2', 'scipy'],
      tests_require=['pytest', 'pytest-remotedata', 'pytest-openfiles'],
      author=AUTHOR,
